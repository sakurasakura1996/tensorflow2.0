...
# This is a bug of Keras. You maybe solve this by removing the plot_model function
# and from keras.utils.vis_utils import plot_model.
inputs = tf.keras.Input(shape=(784,),name='img')
h1 = layers.Dense(32, activation='relu')(inputs)
h2 = layers.Dense(32, activation='relu')(h1)
outputs = layers.Dense(10,activation='softmax')(h2)
model = tf.keras.Model(inputs=inputs,outputs=outputs,name='mnist model')
model.summary()    # 这里时啥意思
# keras.utils.plot_model(model,'mnist_model.png')    # 妈的，。这里一直有点问题
